...
<%@ Page Language="C#" MasterPageFile="~/Template/MainTemplate.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="ViewArchivedItem.aspx.cs" Inherits="Hotel_Management_System.Archive.ViewArchivedItem" %>
            ...
            <div style="width:45%; float:left;">
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td class="tableSeperator" style="width:5%;"></td>
                        <td class="tableData" style="width:85%;">
                            <asp:Label ID="lblArchivedDate" runat="server" Text=""></asp:Label>
                        </td>
                    </tr> 
                </table>
