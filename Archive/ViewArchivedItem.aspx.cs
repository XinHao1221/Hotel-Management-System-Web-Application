...
{
    public partial class ViewArchivedItem : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("ArchiveList.aspx");
        }
...
#pragma warning restore CS0219 // The variable 'counter' is assigned but its value is never used
        ...
        private void setArchivedDate()
        {
            ...
            string date = (string)cmdGetArchivedDate.ExecuteScalar();

            conn.Close();

            // Format archived date before display
            DateTime formatedArchivedDate = Convert.ToDateTime(date);
            lblArchivedDate.Text = formatedArchivedDate.ToShortDateString();
        }
