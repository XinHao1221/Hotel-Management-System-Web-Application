...
<%@ Page Language="C#" MasterPageFile="~/Template/MainTemplate.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="BlockedRoom.aspx.cs" Inherits="Hotel_Management_System.Dashboard.BlockedRoom" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="server">
    ...
    <div>
        ...
        <div class="content">
            ...
            <asp:Repeater ID="RepeaterBlockedRoom" runat="server" OnItemDataBound="RepeaterBlockedRoom_ItemDataBound">
                ...
                <ItemTemplate>
                    <div style="width:95%; margin-left:auto; margin-right:auto;">
                        ...
                        <div style="float:left; width:10%;" class="subFormTableContent">
                            <asp:Label ID="lblStatus" runat="server" Text="" ForeColor="red">Blocked</asp:Label>
