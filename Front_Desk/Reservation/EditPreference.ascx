...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditPreference.ascx.cs" Inherits="Hotel_Management_System.Front_Desk.Reservation.EditPreference" %>
...
<div style="margin-left:8%; margin-top:25px;">
    <div style="float:left;">
        ...
        <div style="float:left;">
            ...
            <div>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPreference" ErrorMessage="Please enter a value." ValidationGroup="addPreferences" CssClass="validatorStyle"></asp:RequiredFieldValidator>
            </div>
        </div>
    </div>
    ...
    <div style="float:left;">
        ...
        <asp:Button ID="btnSavePreference" runat="server" Text="Add" CssClass="subFormBtnSave" OnClick="btnSavePreference_Click" ValidationGroup="addPreferences" ToolTip="Add Preference"/>
...
<div style="width: 80%; margin: auto; clear:both;">
    ...
    <div class="subFormTableContent" style="padding-left:2%;">
        <asp:Label ID="lblNoPReference" runat="server" Text="No item found!" Visible="false"></asp:Label>
    </div>           
</div>
