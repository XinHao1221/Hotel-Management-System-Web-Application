<%@ Page Language="C#" MasterPageFile="~/Template/MainTemplate.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="EquipmentCheckList.aspx.cs" Inherits="Hotel_Management_System.Front_Desk.CheckOut.EquipmentCheckList" %>
                            ...
                            <asp:Repeater ID="RepeaterEquipmentCheckList" runat="server">
                                ...
                                <ItemTemplate>
                                    ...
                                    <div style="float:left;">
                                        <asp:Label ID="lblEquipmentID" runat="server" CssClass="tableData" Text='<%# Eval("EquipmentID") %>' Visible="false"></asp:Label>
