<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewFloor.aspx.cs" Inherits="Hotel_Management_System.Hotel_Configuration_Management.Floor.ViewFloor" %>
        ...
        <div>
            ...
            <div class="content">
                ...
                <div style="margin:20px 0px 20px 50px;">
                    ...
                    <div class="formBtnSave" style="float:left; height:40px; margin:0px 0px 0px 20px;" onclick="location.href='AddFloor.aspx';">
