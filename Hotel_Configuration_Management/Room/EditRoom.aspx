<%@ Page Language="C#" MasterPageFile="~/Template/MainTemplate.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="EditRoom.aspx.cs" Inherits="Hotel_Management_System.Hotel_Configuration_Management.Room.EditRoom" %>
<%@ Register TagPrefix="Feature" TagName="Control" Src="~/Hotel_Configuration_Management/Room/EditFeature.ascx" %>
